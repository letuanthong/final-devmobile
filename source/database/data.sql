INSERT INTO users (
    user_id, user_full_name, user_gender, user_date_of_birth,
    user_identity_number, user_identity_issued_date, user_identity_expires_date,
    user_identity_issued_place, user_identity_expires_place,
    user_place_of_origin, user_place_of_residence,
    user_email, user_password, user_phone_number, user_role, user_picture
)
VALUES 
('5b4f3c3d-9f60-4e2c-908f-1c0ec7c96d8a', 'Nguyễn Văn A', 'male', '1990-01-15',
 '123456789', '2010-01-01', '2030-01-01',
 'TP.HCM', 'TP.HCM',
 'Quảng Nam', 'TP.HCM',
 'vana@example.com', 'pass123', '0938179726', 'customer', NULL),

('41cacc8a-5b72-4e33-9b9f-5090d05f179b', 'Trần Thị B', 'female', '1992-06-22',
 '987654321', '2011-06-01', '2031-06-01',
 'Hà Nội', 'TP.HCM',
 'Hà Nội', 'TP.HCM',
 'thib@example.com', 'pass123', '0938179725', 'officer', NULL);

INSERT INTO ekyc (ekyc_id, user_id, ekyc_image_url, ekyc_verified, ekyc_verified_at)
VALUES
('aacda8a4-e005-4e8f-9001-3b8a93bdfd3a', '5b4f3c3d-9f60-4e2c-908f-1c0ec7c96d8a', 'https://example.com/ekyc/u1.jpg', TRUE, NOW()),
('bf34ccf7-9f95-4931-b6cf-2a69d8baf5b1', '41cacc8a-5b72-4e33-9b9f-5090d05f179b', 'https://example.com/ekyc/u2.jpg', FALSE, NULL);

INSERT INTO accounts (
    account_id, user_id, account_type, account_number,
    account_balance, account_interest_rate, account_monthly_payment
)
VALUES
...
INSERT INTO transactions (
    transaction_id, from_account_id, to_account_id, to_bank_name,
    transaction_amount, transaction_type, transaction_status, otp_verified
)
VALUES
...
INSERT INTO bills (
    bill_id, user_id, bill_type, provider_name,
    bill_amount, bill_due_date, paid, transaction_id
)
VALUES
...
INSERT INTO branches (
    branch_id, branch_name, branch_address, branch_latitude, branch_longitude
)
VALUES
...
INSERT INTO otp_codes (
    otp_id, user_id, otp_code, otp_is_used, expires_at
)
VALUES
