package com.example.dib.payment;
...
public class BillWater extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paybill_water); // Tên layout XML
        ...
        btnPayment.setOnClickListener(v -> {
            ...
            if (phoneNumber.isEmpty()) {
                Toast.makeText(BillWater.this, "Vui lòng nhập số điện thoại", Toast.LENGTH_SHORT).show();
            } else {
                // Xử lý thanh toán
    ...
    private void processPayment(String phoneNumber, int amount) {
        ...
        if (paymentSuccess) {
            ...
            Toast.makeText(BillWater.this, "Thanh toán thành công!", Toast.LENGTH_SHORT).show();
        } else {
            // Thông báo lỗi
            Toast.makeText(BillWater.this, "Thanh toán không thành công. Vui lòng thử lại.", Toast.LENGTH_SHORT).show();
        }
    }
}
